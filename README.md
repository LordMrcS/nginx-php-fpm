...
[![php 8.3](https://img.shields.io/badge/php--fpm-8.3-blue.svg?&logo=php&logoColor=white&style=for-the-badge)](https://www.php.net/ChangeLog-8.php#8.3)
...
## Introduction
This is a Dockerfile to build an alpine based container image running nginx and php-fpm 8.3.x & Composer.

### Versioning
| Docker Tag | GitHub Release | Nginx Version | PHP Version | Base Image | Composer 
|------------|----------------|---------------|-------------|------------|----------|
| latest     | master Branch  | 1.29.8        | 8.3         | Alpine 3.20| 2.9.5    |
| alpine     | migrate-to-alpine Branch | 1.29.8 | 8.3   | Alpine 3.20| 2.9.5    |
...
followed by
```
$ docker build -t nginx-php-fpm:alpine . # PHP 8.3 (Alpine)
```
